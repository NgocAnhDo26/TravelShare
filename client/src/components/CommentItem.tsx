    ...
    return (
        <>
            {parts.map((part, index) => {
                if (index % 2 === 1) {
                    return (
                        <Link to={`/profile/${part}`} key={index} className="text-blue-600 font-semibold no-underline hover:underline">
                            @{part}
                        </Link>
                    );
                }
                ...
                {isEditing ? (
                    ...
                    <div className="flex items-center gap-2">
                        <div className='w-fit max-w-full'>
                            <div className='bg-gray-100 dark:bg-gray-800 rounded-xl px-3 py-2 text-left'>
                                <div className='text-sm font-medium'>{name}</div>
                                {comment.content && (
                                    <p className='text-sm max-w-full break-words whitespace-pre-wrap'>
