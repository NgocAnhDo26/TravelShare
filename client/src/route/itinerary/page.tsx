...
interface Itinerary {
  ...
  endTime: string;
  location: string;
  category: 'attraction' | 'restaurant' | 'accommodation' | 'transportation' | 'activity' | 'shopping' | 'other';
  notes?: string;
}
    ...
    <div className="min-h-screen bg-white py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-black">Trip Itinerary</h1>
            <p className="text-gray-600 mt-1">Your planned activities and schedule</p>
          </div>
          <Button className="bg-black text-white hover:bg-gray-800 border-black cursor-pointer"
          onClick={() => {
                    ...
                    <CardHeader className="pb-3">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex gap-2 ml-4">
                          <Button variant="outline" size="sm" className="border-gray-300 hover:bg-gray-50 cursor-pointer">
                            <Edit className="w-4 h-4" />
                            {/* TODO: Add edit functionality */}
                          </Button>
                          <Button variant="outline" size="sm" className="border-gray-300 hover:bg-gray-50 text-red-600 hover:text-red-700 cursor-pointer">
        ...
        {Object.keys(groupedItineraries).length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">Start planning your trip by adding your first activity.</p>
