...
function TripPlanningContent() {
    const [publicState, setPublicState] = useState<"friends" | "public" | "private">("public");
    ...
    const publicOptions = [
		{
            ...
            label: "Public",
            icon: (
                <svg className="inline mr-2" width="20" height="20" fill="none" viewBox="0 0 24 24">
                    <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2"/>
                    <path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10A15.3 15.3 0 0 1 12 2z" stroke="currentColor" strokeWidth="2"/>
                </svg>
            ),
        },
        {
	...
	return (
		<div className="flex flex-col items-center justify-center min-h-[80vh]">
			<h1 className="text-4xl font-bold mb-8 mt-8 text-center">Plan a new trip</h1>
			<form className="w-full max-w-xl flex flex-col items-center gap-4">
                        ...
                        <>
                            ...
                            <div className="relative" ref={dropdownRef}>
                                ...
                                >
                                    ...
                                    <span>{publicOptions.find(opt => opt.value === publicState)?.label}</span>
                                    ...
                                    <div className="absolute right-0 mt-2 w-40 bg-white rounded-lg shadow-lg border z-10">
                                        {publicOptions.map(option => (
                                            <button
                                                ...
                                                onClick={() => {
                                                    setPublicState(option.value as "friends" | "public" | "private");
                                                    setDropdownOpen(false);
                                                }}
                                            >
                                                {option.icon}
                ...
                <Button
                    type="submit"
                    className="w-full h-14 rounded-full bg-black hover:bg-neutral-800 text-lg font-semibold mt-4 mb-2 text-white"
                >
                    Start planning
                </Button>
            </form>
