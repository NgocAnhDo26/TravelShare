            ...
            <div className="w-full">
                <Button 
                    ...
                    className={cn(
                        ...
                        isFollowing ? "bg-gray-200 text-gray-800 hover:bg-gray-300" : "bg-orange-500 text-white hover:bg-orange-600"
                    )}
                >
...
const TravelLogCard: React.FC<TravelLogCardProps> = ({ 
    ...
    return (
        <div className="bg-white rounded-xl shadow-md p-6 flex flex-col text-left">
            ...
            <div className="space-y-3 flex-grow overflow-y-auto custom-scrollbar pr-4" style={{ height: '200px' }}>
                {travelLog.length > 0 ? (
...
const OtherProfilePage: React.FC = () => {
    ...
    const otherUserData = {
        ...
        followers: 1140,
        following: 10,
        avatarUrl: "https://maunailxinh.com/wp-content/uploads/2025/05/hinh-anh-trai-dep-6-mui-viet-nam.jpg", // Ảnh đại diện của người khác
        countriesVisited: 20, 
        citiesVisited: 50, 
        regionsVisited: 10, 
    ...
    const currentUserAvatar = "https://maunailxinh.com/wp-content/uploads/2025/05/hinh-anh-trai-dep-6-mui-viet-nam.jpg"; // Ảnh đại diện của bạn
