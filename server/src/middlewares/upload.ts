...
import supabase from '../models/file.client';
...
async function uploadFileToSupabase(file: Express.Multer.File): Promise<string> {
...
const uploadToSupabase = async (req: Request, res: Response, next: NextFunction) => {
  if (!req.file) {
